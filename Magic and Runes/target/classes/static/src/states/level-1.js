MagicAndRunes.level_1State = function(game) {
    ...
    var facing_j1													//Almacena a dónde apinta el jugador 1 y el jugador 2
    var vida,mana;
    var state = 'idle'
...
//-------------------------------------como suelo sobre el que se puede saltar.
    ...
    MagicAndRunes.level_1State.prototype = {
    ...
    create: function() {
        ...
        medidor=game.add.sprite(292,20,'niv-1');							//Le asignamos la imagn al medidor
