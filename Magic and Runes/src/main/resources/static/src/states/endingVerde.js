MagicAndRunes.endingStateVerde = function(game) {
...
var yy = [];
var zz = [];
MagicAndRunes.endingStateVerde.prototype = {
    ...
    create: function() {
        ...
        if(game.global.player1.id == 0){
        	var victory = game.add.text(game.world.centerX,game.world.centerY,"VICTORIA",{font:"40px Arial",fill:"#00FF1E",align:"center"})
        	victory.anchor.setTo(0.5,0.5)
        }else if(game.global.player1.id == 1){
        	var defeat = game.add.text(game.world.centerX,game.world.centerY,"DERROTA",{font:"40px Arial",fill:"#FF8000",align:"center"})
