MagicAndRunes.level_dcha1State = function(game) {
    ...
    function miColisionDcha1(mago_izquierda,spells){
        console.log("yes");
    ...
    function miColisionDcha12(mago_derecha,hechizos){
        console.log("no");
    ...
    function trampaNaranjaDcha1(mago_izquierda,enchantments){
        console.log("yes");
    ...
    function trampaVerdeDcha1(mago_derecha,enchantments2){
        console.log("yes");
        ...
        if(mago_derecha.vida<=0){
            ...
            mago_izquierda.mana=100;
            mago_derecha.vida=100;
            game.state.start("level_dcha2State");
        }
        //dañoJ2+=20;
...
MagicAndRunes.level_dcha1State.prototype = {
    ...
    update: function() {
        ...
        game.physics.arcade.collide(mago_izquierda,spellsDcha,miColisionDcha1,null,this);
        game.physics.arcade.collide(mago_izquierda,spellsIzq,miColisionDcha1,null,this);
        game.physics.arcade.collide(mago_derecha,hechizosDcha,miColisionDcha12,null,this);
        game.physics.arcade.collide(mago_derecha,hechizosIzq,miColisionDcha12,null,this);
        
        game.physics.arcade.collide(mago_derecha,enchantments2,trampaVerdeDcha1,null,this);
        game.physics.arcade.collide(mago_izquierda,enchantments,trampaNaranjaDcha1,null,this);
